...
var ResultsList = function (_Component) {
  ...
  ResultsList.prototype._renderElement = function _renderElement(rowData) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_semanticUiReact.Item.Image, { size: 'small', src: 'https://via.placeholder.com/200' }),
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          _react2.default.createElement(_semanticUiReact.Label, { icon: 'globe', content: 'My label' })
        )
      )
    );
  };
