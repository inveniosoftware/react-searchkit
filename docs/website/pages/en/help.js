...
class Help extends React.Component {
  render() {
    const supportLinks = [
      ...
      {
        content:
          "Join the [Invenio Discord channel](https://discord.gg/8qatqBC) to ask questions and get help.",
      ...
      <div className="docMainWrapper wrapper">
        <Container className="mainContainer documentContainer postContainer">
          <div className="post">
            ...
            <p>
              <MarkdownBlock>
                React-SearchKit is born at [CERN](https://home.cern). It is under active
                development and used by websites built on top of
